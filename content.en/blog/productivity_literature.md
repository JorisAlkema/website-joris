...
- **Deep Work** by Cal Newport
	- I could definitely not find myself in the practical strategy's he proposes, nor the philosophy behind it (the whole shallow work vs deep work dichotomy). 
- **hyper focus** by Chris Bailey
	- Is in the same street as Deep Work, and both are doing what atomic habits does for habits, but for focus, in a worse way. I don't think either book actually provides a way to actually focus better. They both just explain why focus is important, and give some practical tips on how to set up your environment to make it easier to focus. But neither actually helps you with the actual act of focusing.
- **De kunst van Kaizen** by Robert Maurer
	- Another book about habits, but with a different approach. It focuses on the idea of how to actually make those small crucial changes that lead to big results over time. It emphasizes the importance of taking small steps, and how to overcome the fear of change. I found it incredibly practical and the information to be presented in a dense way, which is something I appreciate, as other books tend to be quite fluffy. 
